...
const QuerySchema = Type.Object({
  ...
  intent: Type.Union([
    ...
    description: "Required task intent. exact_url, research, and image use GPT-6 Astra with medium reasoning.",
  }),
